...
class PairClosureResultTests(unittest.TestCase):
    def test_result_records_strict_commit_state(self):
        ...
        self.assertTrue(result.lower_after_exact)
