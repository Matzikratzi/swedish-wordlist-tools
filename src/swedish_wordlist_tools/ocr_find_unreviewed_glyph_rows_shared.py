...
def main() -> int:
    ...
    print(
        ...
        f"checkpoints={stats.get('checkpoint_calls', 0)}/"
        f"{stats.get('checkpoint_success', 0)} "
        f"checkpoint_commits={stats.get('checkpoint_commits', 0)} "
        f"checkpoint_placements={stats.get('checkpoint_placements', 0)} "
