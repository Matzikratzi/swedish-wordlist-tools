...
def interpret_playable_verb_slots(record: dict[str, Any]) -> LexemeSlots | None:
    """Interpret a playable verb, preferring the strict row parser.

    The new shared clean-room verb generator is intentionally audited separately
    before replacing this established export path. Multiword lemmas and affix
    entries remain excluded before any parser is called.
    """
